...
def add_old_tournament_specific(app, comps_in: dict[str, Tournament]):
    comps = comps_in.copy()
    comps[None] = UniversalTournament()

    @app.get("/old/<tournament>/")
    def old_home_page(tournament):
        ...
        return (
            render_template_sidebar(
                "old_tournament_specific/tournament_home.html",
    ...
    @app.get("/old/<tournament>/fixtures/")
    def old_fixtures(tournament):
        ...
        return (
            render_template_sidebar(
                "old_tournament_specific/site.html",
                fixtures=fixtures,
                finals=finals,
    ...
    @app.get("/old/<tournament>/fixtures/detailed")
    def old_detailed_fixtures(tournament):
        ...
        return (
            render_template_sidebar(
                "old_tournament_specific/site_detailed.html",
                fixtures=fixtures,
                finals=finals,
                tournament=link(tournament),
                t=comps[tournament],
    ...
    @app.get("/old/<tournament>/teams/")
    def old_stats_directory_site(tournament):
        teams = [
            i
        ...
        return (
            render_template_sidebar(
                "old_tournament_specific/stats.html",
                teams=teams,
                tournament=link(tournament),
            ),
            200,
    ...
    @app.get("/old/<tournament>/teams/<team_name>/")
    def old_stats_site(tournament, team_name):
        if team_name not in [i.nice_name() for i in comps[tournament].teams]:
            return (
                render_template(
                    "old_tournament_specific/game_editor/game_done.html",
        ...
        return (
            render_template_sidebar(
                "old_tournament_specific/each_team_stats.html",
    ...
    @app.get("/old/<tournament>/games/<game_id>/display")
    def old_scoreboard(tournament, game_id):
        ...
        return (
            render_template_sidebar(
                "old_tournament_specific/scoreboard.html",
                game=game,
                status=status,
                players=players,
                teams=teams,
    ...
    @app.get("/old/<tournament>/games/<game_id>/")
    def old_game_site(tournament, game_id):
        if int(game_id) >= len(comps[tournament].games_to_list()):
            return (
                render_template(
                    "old_tournament_specific/game_editor/game_done.html",
        ...
        return (
            render_template_sidebar(
                "old_tournament_specific/game_page.html",
                game=game,
                status=status,
    ...
    @app.get("/old/<tournament>/ladder/")
    def old_ladder_site(tournament):
        priority = {
            "Team Names": 1,
            "Games Played": 2,
            "Games Won": 1,
        ...
        return (
            render_template_sidebar(
                "old_tournament_specific/ladder.html",
    ...
    @app.get("/old/<tournament>/players/")
    def old_players_site(tournament):
        priority = {
            "Name": 1,
            "B&F Votes": 1,
            "Elo": 2,
        ...
        return (
            render_template_sidebar(
                "old_tournament_specific/players.html",
    ...
    @app.get("/old/<tournament>/players/detailed")
    def old_detailed_players_site(tournament):
        players = [
            (
                i.name,
                i.team.nice_name(),
        ...
        return (
            render_template_sidebar(
                "old_tournament_specific/players_detailed.html",
    ...
    @app.get("/old/<tournament>/players/<player_name>/")
    def old_player_stats(tournament, player_name):
    ...
    @app.get("/old/<tournament>/officials/<nice_name>/")
    def old_official_site(tournament, nice_name):
        ...
        return (
            render_template_sidebar(
                "old_tournament_specific/official.html",
                name=official.name,
    ...
    @app.get("/old/<tournament>/officials/")
    def old_official_directory_site(tournament):
        official = [(i, i.nice_name()) for i in comps[tournament].officials]
        return (
            render_template_sidebar(
                "old_tournament_specific/all_officials.html",
                officials=official,
                tournament=link(tournament),
            ),
            200,
    ...
    @app.get("/old/<tournament>/games/<game_id>/edit/")
    @officials_only
    def old_game_editor(tournament, game_id):
        if int(game_id) >= len(comps[tournament].games_to_list()):
        ...
        if key not in [game.primary_official.key, game.scorer.key] and not is_admin:
            ...
            return (
                render_template(
                    "old_tournament_specific/game_editor/game_start.html",
                    players=[i.tidy_name() for i in players],
                    teams=teams,
                    game=game,
                    tournament=link(tournament),
            ...
            return (
                render_template(
                    f"old_tournament_specific/{'' if not is_admin else 'admin/'}game_editor/edit_game.html",
                    players=[i.tidy_name() for i in players],
            ...
            return (
                render_template(
                    "old_tournament_specific/game_editor/team_signatures.html",
                    players=[i.tidy_name() for i in players],
                    swap=visual_str,
                    teams=teams,
                    game=game,
            ...
            return (
                render_template(
                    "old_tournament_specific/game_editor/finalise.html",
                    players=[i.tidy_name() for i in players],
                    swap=visual_str,
                    teams=teams,
                    game=game,
    ...
    @app.get("/old/<tournament>/create")
    @officials_only
    def old_create_game(tournament):
        ...
        return (
            render_template(
                "old_tournament_specific/game_editor/create_game_teams.html",
                tournament=link(tournament),
                officials=officials,
                teams=teams,
                id=next_id,
    ...
    @app.get("/old/<tournament>/round")
    @admin_only
    def old_new_round_site(tournament):
        if not comps[tournament].fixtures_class.manual_allowed():
            return (
                render_template(
                    "old_tournament_specific/game_editor/game_done.html",
    ...
    @app.get("/old/<tournament>/createPlayers")
    def old_create_game_players(tournament):
        if not comps[tournament].fixtures_class.manual_allowed():
            return (
                render_template(
                    "old_tournament_specific/game_editor/game_done.html",
        ...
        return (
            render_template(
                "old_tournament_specific/game_editor/create_game_players.html",
                tournament=link(tournament),
                officials=officials,
                players=players,
            ),
    ...
    @app.get("/old/<tournament>/raw/")
    def old_raw_tournament(tournament):
        players = comps[tournament].players
        headers = []
        for k, v in get_player_stats(
    ...
    @app.get("/old/teams/")
    def old_universal_stats_directory_site():
        return old_stats_directory_site(None)

    @app.get("/old/teams/<team_name>/")
    def old_universal_stats_site(team_name):
        return old_stats_site(None, team_name)

    @app.get("/old/ladder/")
    def old_universal_ladder_site():
        return old_ladder_site(None)

    @app.get("/old/players/")
    def old_universal_players_site():
        return old_players_site(None)

    @app.get("/old/players/detailed")
    def old_unviersal_detailed_players_site():
        return old_detailed_players_site(None)

    @app.get("/old/players/<player_name>/")
    def old_universal_player_stats(player_name):
        return old_player_stats(None, player_name)

    @app.get("/old/officials/<nice_name>/")
    def old_universal_official_site(nice_name):
        return old_official_site(None, nice_name)

    @app.get("/old/officials/")
    def old_universal_official_directory_site():
        return old_official_directory_site(None)

    @app.get("/old/raw/")
    def old_raw():
        return old_raw_tournament(None)
