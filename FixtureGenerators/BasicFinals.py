...
class BasicFinals(FixturesGenerator):
    ...
    def _end_of_round(self, tournament_id):
        ...
        if len(finals_games) > 2:
            ...
            manage_game.create_game(tournament_id, ladder[0][0].id, ladder[3][0].id, is_final=True,
                                    round_number=last_game.round_number + 1)
            manage_game.create_game(tournament_id, ladder[1][0].id, ladder[2][0].id, is_final=True,
                                    round_number=last_game.round_number + 1)
