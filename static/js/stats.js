function reloadGraph(tournament) {
    ...
    if (tournament) {
        ...
        document.getElementById("graph").src = `/graph_player?x=${x}&y=${y}&player=${player}&tournament=${tournament}`
    } else {
        document.getElementById("graph").src = `/graph_player?x=${x}&y=${y}&player=${player}`
    }
